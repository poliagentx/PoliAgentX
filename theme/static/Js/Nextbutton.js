  ...
  document.addEventListener('DOMContentLoaded', function() {
    class IndicatorUploader {
      ...
      async uploadFile(file) {
        ...
        formData.append('government_indicators', file);
      ...
      handleUploadSuccess(message, stats) {
        ...
        setTimeout(() => {
          ...
          this.elements.uploadText.innerHTML = `
            ...
            ${stats ? `<br><span class="text-sm text-gray-600">${stats.total_indicators} indicators processed</span>` : ''}
          `;
        }, 500);
      ...
      handleUploadError(message) {
        ...
        `;
        this.elements.uploadText.textContent = 'Drop your indicators file here';
