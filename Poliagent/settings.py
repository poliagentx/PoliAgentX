"""
Django settings for Poliagent project.
...
WSGI_APPLICATION = 'Poliagent.wsgi.application'
...
# Optional: enable offline compression
COMPRESS_OFFLINE = True

# Add all necessary staticfiles finders
STATICFILES_FINDERS = [
