# PoliagentX/backend-poliagentx/data_preparation_indicators.py

import pandas as pd
import numpy as np
import os

def prepare_indicators(input_csv_path, output_csv_path):
    ...
    # handle edge cases for successRates
    ...
    df['qm'] = -0.30 # quality of monitoring
